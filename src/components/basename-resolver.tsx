  ...
  return (
    <div className="workbench-module">
      ...
      <div className="relative">
        <span className="absolute left-3 top-2 font-mono text-xs text-[#787878] pointer-events-none">
          &gt;
        </span>
        <input
          type="text"
      ...
      {/* Output */}
      {result && (
        <div className="mt-3 p-2.5 bg-[#0a0c12] border border-[#1a2a3a]">
          <p className="font-mono text-xs text-[#00C853] break-all">{result}</p>
        </div>
      )}

      {error && (
        <div className="mt-3 p-2.5 bg-[#0a0c12] border border-[#FF3B30]">
